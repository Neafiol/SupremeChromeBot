...
function onl(){
  document.getElementById("btngo").addEventListener("click", function() {
    ...
    dt={
        fio: get_cookie ( "fio" ),
        order_email: get_cookie ( "order_email" ),
        adress: get_cookie ( "adress" ),
        order_tel: get_cookie ( "order_tel" ),
        order_billing_city: get_cookie ( "order_billing_city" ),
        order_billing_city: get_cookie ( "card_nom" ),
        order_billing_city: get_cookie ( "order_billing_city" ),
        order_billing_city: get_cookie ( "order_billing_zip" ),
        order_billing_city: get_cookie ( "cvv" )
    }
    chrome.extension.sendMessage({cmd:'data', h:dt, function(backMessage){
...
function set_cookie ( name, value )
{
  ...
  var cookie_date = new Date ( 2020, 1, 15 );
